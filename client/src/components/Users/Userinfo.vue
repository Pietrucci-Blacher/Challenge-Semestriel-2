        ...
        <div class="flex flex-col overflow-auto">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select
                                            id="country"
                                            class="mt-1 block form-select w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-200 focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                        >
            ...
            <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                ...
                >
                    <div>
                        ...
                        <p class="mt-1 text-sm leading-5 text-gray-500">
                            This section is about notification system
                        </p>
                    </div>
                    <div class="mt-5 md:mt-0 md:col-span-2">
            ...
            <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                ...
                >
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <button
                            class="py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
